...
main_columns = ['particle_name', 'config','Incident_energy','Detected_energy','AF', 'AT2', 'AT1', 'AU2', 'AU1', 'AO','secondary_particle_num','start_time','end_time','total_time']
...
class MyDetectorConstruction(G4VUserDetectorConstruction):
    ...
    def ConstructSDandField(self):
        ...
        G4SDKineticEnergyFilter().SetKineticEnergy(elow=Emin, ehigh = Emax)
...
class MyEventAction(G4UserEventAction):
    ...
    def EndOfEventAction(self, anEvent):
        ...
        dataframe.loc[self.anEvent_num, 'secondary_particle_num'] = self.secondaryparticle_num
...
class MySteppingAction(G4UserSteppingAction):
    ...
    def UserSteppingAction(self, aStep):
        if ((aStep.GetTotalEnergyDeposit())/keV < Emin*keV):
