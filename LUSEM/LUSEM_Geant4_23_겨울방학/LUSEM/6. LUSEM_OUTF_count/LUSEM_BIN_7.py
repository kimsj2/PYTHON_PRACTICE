...
class MyRunAction(G4UserRunAction):
    ...
    def BeginOfRunAction(self, aRun):
        ...
        createFolder(f'detail_data({self.start_time_str})')
    ...
    def EndOfRunAction(self, aRun):
        ...
        dataframe.to_csv(f'detail_data({self.start_time_str})/LUSEM_main.csv')
        dataframe_bins.to_csv(f'detail_data({self.start_time_str})/LUSEM_bin.csv')
    ...
    def EndOfEventAction(self, anEvent):
        ...
        for i in range(self.detector_num):
            ...
            for _, edep in evtMap:
                dataframe.loc[anEvent.GetEventID(), self.Dets[i]] = edep/keV
