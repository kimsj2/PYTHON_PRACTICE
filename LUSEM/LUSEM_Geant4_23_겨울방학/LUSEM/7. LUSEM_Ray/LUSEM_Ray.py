...
# 병렬로 실행할 스레드의 수를 설정합니다.
num_threads = 4

# 각 스레드에서 실행할 이벤트의 수를 계산합니다.
events_per_thread = 10000 // num_threads

# 각 스레드에 대한 작업을 시작합니다.
result_ids = []
for _ in range(num_threads):
    result_ids.append(run_simulation.remote(events_per_thread))
