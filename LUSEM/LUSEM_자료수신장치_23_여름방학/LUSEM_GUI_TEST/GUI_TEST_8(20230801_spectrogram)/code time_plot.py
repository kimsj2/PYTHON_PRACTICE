...
init_path = r'Z:\2023_Summer\자료 수신 장치\LUSEM_GUI_TEST\GUI_TEST_7(20230728_TAP_HEX)\split_day'


data = pd.read_csv(os.path.join(init_path,'time.txt'), header=None, sep='\s+')
...
ax1.hist(np.array(s0)*1e3, bins=100)

ax1.set_yscale('log')
#ax6.set_ylim([0,80])
ax1.set_xlim([0,50])
ax1.set_xlabel('Processing time, ms', size=xl, fontweight='bold')
