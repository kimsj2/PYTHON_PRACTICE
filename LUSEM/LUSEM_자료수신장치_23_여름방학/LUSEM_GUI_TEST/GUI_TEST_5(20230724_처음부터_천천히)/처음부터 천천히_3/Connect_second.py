...
class MyWindow(QMainWindow):
    ...
    def stop_connection(self):
        ...
        self.connect.setEnabled(True)  # 버튼 활성화
        self.hex_data = ""
    ...
    def connect_tcp_ip(self):
        while not self.stop_flag.is_set():
            ...
            sci, noi, soh, dum = self.datpar(self.hex_data)
            e_time = time.process_time()
            with open(r'C:\Users\SSIL_B104_1\Desktop\자료 수신 장치\LUSEM_GUI_TEST\GUI_TEST_5(20230724_처음부터_천천히)\처음부터 천천히_3\test3_seconds.txt','a') as f:
